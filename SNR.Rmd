...
# setwd('C:/Users/britta themann/Documents/SNR_Calculation/')
setwd('C:/Users/Britta Themann/Documents/SNR_Calculation/')
...
myfunc <- function(layer.no){
  # tryCatch({ # skip defective layers # DOES NOT WORK INSTEAD OF FILE TRY CATCH
  r <- subset(s,layer.no)
  ...
  # }, error=function(e){cat("\nERROR :",conditionMessage(e),"\nDefective file",file.no,"skipped!\n",filename,"\nLayer No.",layer.no,"\n")}) # skip defective layers # DOES NOT WORK INSTEAD OF FILE TRY CATCH
}
```
